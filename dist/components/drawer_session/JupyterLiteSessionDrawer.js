...
class JupyterLiteSessionDrawer extends BaseJupyterLiteSessionComponent {
    render() {
        ...
        return (_jsx("div", { style: { display: show ? "block" : "none" }, children: _jsx(ResizableDrawer, { open: show, onClose: onHide, containerRef: containerRef, children: _jsx(JupyterLiteSession, { defaultNotebookPath: this.DEFAULT_NOTEBOOK_PATH }) }) }));
    }
}
